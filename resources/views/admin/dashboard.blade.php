        ...
        <div class="flex-1 flex flex-col overflow-hidden">
            ...
            <main class="flex-1 overflow-y-auto p-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
                    <a href="{{ route('admin.jobs') }}" class="bg-gradient-to-r from-blue-500 to-blue-600 rounded-xl shadow-sm p-6 text-white hover:from-blue-600 hover:to-blue-700 transition">
                        <div class="flex items-center">
                            ...
                            <div>
                                ...
                                <p class="text-blue-100 text-sm">Tambah, edit, dan hapus lowongan kerja</p>
                            </div>
                        </div>
                    </a>
                    ...
                    <div class="bg-gradient-to-r from-purple-500 to-purple-600 rounded-xl shadow-sm p-6 text-white">
                        <div class="flex items-center">
                            ...
                            <div>
                                ...
                                <p class="text-purple-100 text-sm">Lihat dan kelola data pengguna</p>
                            </div>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="flex items-center justify-between p-4 bg-gray-50 rounded-lg">
                                <div class="flex items-center">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-sm text-gray-500">PT Tech Indonesia · Jakarta</p>
                                    </div>
                                </div>
                            ...
                            <div class="flex items-center justify-between p-4 bg-gray-50 rounded-lg">
                                <div class="flex items-center">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-sm text-gray-500">Startup Creative · Bandung</p>
                                    </div>
                                </div>
                                <span class="px-2.5 py-1 text-xs font-medium bg-green-100 text-green-700 rounded-full">
                                    Aktif
