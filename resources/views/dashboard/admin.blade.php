...
<body class="bg-gray-50">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between items-center h-16">
                <div class="flex items-center">
                    ...
                    <span class="ml-3 px-2.5 py-1 text-xs font-medium bg-purple-100 text-purple-700 rounded-full">Employer</span>
                </div>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div class="flex justify-between items-center mb-8">
            <div>
                <h2 class="text-3xl font-bold text-gray-900">Dashboard Perusahaan</h2>
                <p class="mt-2 text-gray-600">Kelola lowongan pekerjaan dan rekrutmen</p>
            </div>
        </div>
    </div>
</body>
